...
const sitemapData = [
  ...
  },
  {
    ...
    subItems: [
      { label: 'Directivos', id: 'directivos' },
      { label: 'Docentes', id: 'docentes' }
    ]
  },
  {
    title: 'Vida Escolar',
  ...
  },
  {
    ...
    subItems: [
      { label: 'Protocolos Colegio', id: 'protocolos' }
    ]
  },
  {
    title: 'Contacto',
      ...
      <div className="bg-[#1a4731] text-white text-[10px] md:text-xs py-2 hidden md:block border-b border-green-800">
        <div className="container mx-auto px-4 flex justify-between items-center max-w-7xl">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="bg-red-600 text-white px-5 py-1.5 rounded-full font-black text-[10px] uppercase hover:bg-red-700 transition-all shadow-sm border border-red-500">
              Webmail
            </button>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 max-w-7xl h-20 md:h-24 flex justify-between items-center">
        ...
        >
          ...
          <div className="flex flex-col relative">
            <span className="absolute -top-4 -right-2 font-serif italic text-red-600 text-lg transform rotate-3 select-none">
              {currentAge} años
            </span>
        ...
        <div className="fixed inset-0 z-[100] xl:hidden">
          ...
          <div className="absolute top-0 right-0 w-[85%] max-w-sm h-full bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-500">
            ...
            <div className="p-6 border-t bg-slate-50 flex flex-col gap-3">
              ...
              <button className="bg-red-600 text-white p-4 rounded-xl text-center font-black text-[10px] uppercase tracking-widest shadow-lg active:scale-95 transition-all">
                Webmail
              </button>
            </div>
          </div>
